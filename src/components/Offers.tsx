...
const Offers = () => {
  ...
  return (
    <div className="bg-white " dir="rtl">
      <section>
        <div className="max-w-[80%] mx-auto px-4 sm:px-6 py-16">
          ...
          <div className="space-y-4">
            {offersdata.map((offer, index) => (
              ...
              >
                ...
                >
                  <div className="">
                    <h3 className="text-md font-semibold my-2">{offer.name}</h3>
                    <p className="text-xs">{offer.description}</p>
                  </div>
                  <button className="text-white bg-primary font-medium md:font-semibold px-8 py-3 rounded-lg shadow-md hover:bg-gray-100 transition-colors duration-300 text-[10px]  sm:text-sm">
                    اشترك الآن
                  </button>
                </div>
