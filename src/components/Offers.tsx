                      ...
                      >
                        ...
                        <a
                          href={`https://wa.me/${
                            ...
                            `مرحبًا،\nأرغب بالحصول على مزيد من التفاصيل حول : "${offer.name}".\nهل ما زال التسجيل متاحًا؟ وما هي المواعيد والتكاليف؟\nشكرًا لكم.`
                          )}`}
                          title="offer button"
                          className="text-white hidden sm:inline bg-primary px-8 py-3 rounded-lg shadow-md hover:bg-primary/80 transition-colors duration-300 text-[10px]  text-sm sm:text-base"
                        >
                          {t("offer.button")}
                        </a>
                      </div>
                          ...
                          >
                            {offer?.courses.length > 0 && (
                              <div className="px-4 pb-4 text-sm sm:text-base text-paragraph leading-relaxed">
                                ...
                                <a
                                  title="offer button"
                                  className="text-white inline  w-full sm:hidden bg-primary px-8 py-3 rounded-lg shadow-md hover:bg-primary/80  text-sm sm:text-base"
                                >
                                  {t("offer.button")}
                                </a>
                              </div>
