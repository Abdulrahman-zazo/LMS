  ...
  return (
    <div>
      <div className="bg-primary py-12 px-8 md:p-12 rounded-3xl shadow-xl text-white relative overflow-hidden w-[90%] max-w-[1240px] mx-auto mt-20 sm:mt-24 mb-2 sm:mb-8">
        ...
        {/* Main Content */}
        <div className="flex flex-col gap-6 md:gap-2 md:flex-row justify-around text-center md:text-start items-center mx-auto">
          {/* Text Side */}
          <div className="relative z-10">
            {ready ? (
              <>
                <motion.h1
                  className="text-xl sm:text-3xl md:text-3xl lg:text-4xl max-w-xl mx-auto font-semibold mt-8 mb-2 sm:mb-6 leading-14 sm:leading-16"
                ...
                <motion.p
                  className="text-base md:text-lg lg:text-xl  mb-4 md-8 max-w-xl mx-auto"
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.7, ease: "easeOut" }}
                >
                  {t("HeroHome.text1")}
                ...
                <MotionLink
                  ...
                  title={t("HeroHome.text3")}
                  className="bg-white text-primary font-semibold px-2 lg:px-8 py-3 rounded-lg shadow-md hover:bg-gray-100 transition-colors duration-300 text-sm sm:text-base cursor-pointer"
