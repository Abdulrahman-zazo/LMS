function Terms() {
  return (
    <div className="w-5/6 m-auto my-10  text-right" dir="rtl">
      <h1 className="mb-6 text-center text-xl font-bold md:text-2xl font-almarai">
        شروط الاستخدام
      </h1>
      ...
      <span className=" text-xs sm:text-sm text-paragraph py-4 block leading-6">
      ...
      <ol className="m-4 list-decimal">
        <li>
          ...
          <ol className="list-disc m-4  text-xs sm:text-sm text-paragraph leading-6">
            <li>
